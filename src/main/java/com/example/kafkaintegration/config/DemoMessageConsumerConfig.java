...
public class DemoMessageConsumerConfig implements KafkaConsumerProperties {
    ...
    public DemoMessageConsumerConfig(KafkaAppProperties kafkaAppProperties) {
        KafkaAppProperties.ResolvedConsumer resolved = kafkaAppProperties.resolveConsumer("demo-message");
