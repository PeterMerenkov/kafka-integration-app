...
public class InventoryAdjustedConsumerConfig implements KafkaConsumerProperties {
    ...
    public InventoryAdjustedConsumerConfig(KafkaAppProperties kafkaAppProperties) {
        KafkaAppProperties.ResolvedConsumer resolved = kafkaAppProperties.resolveConsumer("inventory-adjusted");
