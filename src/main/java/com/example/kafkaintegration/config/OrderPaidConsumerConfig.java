...
public class OrderPaidConsumerConfig implements KafkaConsumerProperties {
    ...
    public OrderPaidConsumerConfig(KafkaAppProperties kafkaAppProperties) {
        KafkaAppProperties.ResolvedConsumer resolved = kafkaAppProperties.resolveConsumer("order-paid");
